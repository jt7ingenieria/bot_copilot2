# 🌀 Linux Nexus-Win v1.0

Linux Nexus-Win es un sistema operativo revolucionario basado en Debian, diseñado para ofrecer el máximo rendimiento, privacidad total y una compatibilidad sin precedentes con aplicaciones de Windows.
...
Para construir la imagen ISO de Linux Nexus-Win:
