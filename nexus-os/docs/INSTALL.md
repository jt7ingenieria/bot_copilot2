# 🛠️ Instalación de Nexus OS

Este documento detalla los pasos necesarios para instalar y configurar Nexus OS en hardware real o en una máquina virtual.
...
1.  **Creación del Medio de Arranque:**
    Usa una herramienta como Rufus o Ventoy para grabar la ISO generada (`nexus-os.iso`) en tu unidad USB.
...
4.  **Detección y Configuración Adaptativa:**
    Al finalizar la instalación visual, Nexus OS ejecutará automáticamente sus scripts de post-instalación:
...
5.  **Reinicio Final:**
    Una vez que el proceso de post-instalación termine, reinicia tu PC, retira el USB y disfruta de Nexus OS.
